    ...
    <div class="row g-4">
        ...
        <div class="col-lg-9">
            ...
            <div class="admin-header">
                <div>
                    <h1 class="admin-title">Thêm Đối Tác Mới</h1>
                    <p class="text-muted mb-0 fw-medium">Thêm thông tin nhà cung cấp dịch vụ hoặc đối tác vận hành tour.</p>
                </div>
                <div>
            ...
            <div class="admin-card">
                <form method="POST" action="manager.php?action=storePartner">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input class="form-control fw-medium" name="partner_name" placeholder="Ví dụ: Công ty Du lịch Viettravel" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold"><i class="bi bi-person-badge text-warning me-1"></i> Người liên hệ</label>
                            <input class="form-control" name="contact_person" placeholder="Ví dụ: Nguyễn Văn A">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="phone" placeholder="Ví dụ: 0901234567" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold"><i class="bi bi-envelope-fill text-danger me-1"></i> Email</label>
                            <input type="email" class="form-control" name="email" placeholder="Ví dụ: contact@congty.com">
                        </div>
                    </div>

                    <div class="mb-5">
                        <label class="form-label fw-bold"><i class="bi bi-geo-alt-fill text-info me-1"></i> Địa chỉ văn phòng</label>
                        <input class="form-control" name="address" placeholder="Nhập địa chỉ đầy đủ (Số nhà, đường, quận/huyện, tỉnh/thành phố)...">
                    </div>

                    <div class="d-flex justify-content-end gap-2 border-top pt-4">
                        <button type="reset" class="btn btn-light px-4 shadow-sm">Làm mới</button>
                        <button type="submit" class="btn btn-primary px-4 fw-bold shadow-sm">
                            <i class="bi bi-plus-lg me-1"></i> Tạo Đối Tác
                        </button>
                    </div>
